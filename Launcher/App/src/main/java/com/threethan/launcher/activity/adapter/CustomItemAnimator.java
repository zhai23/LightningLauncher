...
public class CustomItemAnimator extends SimpleItemAnimator {
    ...
    void animateMoveImpl(final RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        if (deltaX != 0) {
            view.animate().translationX(0).setInterpolator(new FastOutSlowInInterpolator());
        }
        if (deltaY != 0) {
            view.animate().translationY(0).setInterpolator(new FastOutSlowInInterpolator());
        }
        final ViewPropertyAnimator animation = view.animate();
