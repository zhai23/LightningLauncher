...
public class MainActivity extends Activity {
    ...
    private boolean launch() {
        ...
        launchIntent = getPackageManager().getLaunchIntentForPackage("com.basti564.dreamgrid");
        if (launchIntent != null) return launchIt(launchIntent);
        launchIntent = getPackageManager().getLaunchIntentForPackage("com.veticia.piLauncherNext");
        if (launchIntent != null) return launchIt(launchIntent);
        return false;
    }
